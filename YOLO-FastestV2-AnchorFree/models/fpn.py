...
class DWConvblock(nn.Module):
    def __init__(self, input_channels, output_channels, size):
        ...
        self.block = nn.Sequential(
            # depthwise
            nn.Conv2d(output_channels, output_channels, size, 1, padding=size//2, groups=output_channels, bias=False),
...
class LightFPN(nn.Module):
    def __init__(self, input2_depth, input3_depth, out_depth):
        ...
        self.cls_head_2 = DWConvblock(input2_depth, out_depth, 3)
        self.reg_head_2 = DWConvblock(input2_depth, out_depth, 3)

        self.reg_head_3 = DWConvblock(input3_depth, out_depth, 3)
        self.cls_head_3 = DWConvblock(input3_depth, out_depth, 3)
